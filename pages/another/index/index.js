...
Page({
  ...
  */
  ...
  onShareAppMessage: function () {
    return {
      title: config.defaultShareText || '',
      path: '/pages/another/index/index', //	转发路径	当前页面 path ，必须是以 / 开头的完整路径	
      imageUrl: config.defaultShareImg || '', //	自定义图片路径，可以是本地文件路径、代码包文件路径或者网络图片路径，支持PNG及JPG，不传入 imageUrl 则使用默认截图。显示图片长宽比是 5:4		1.5.0
      success(res){},//	转发成功的回调函数		1.1.0
      fail(err){},// 转发失败的回调函数		1.1.0
